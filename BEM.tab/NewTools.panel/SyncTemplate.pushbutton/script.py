...
def build_layers(doc, element_type, layers_list):
    try:
        ...
        # Structure Reuse (Fix for Floor EndCaps)
    ...
    try:
        ...
        for name, layers in data.items():
            ...
            if typ:
                ...
                # 2. APPLY TAG (The Update)
                apply_tag(typ)

        t.Commit()
        output.print_md("### ✅ Success! Processed & Tagged {} Assemblies.".format(count))
